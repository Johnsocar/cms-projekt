...
class __TwigTemplate_f487daf66cb46f29b9f81195844c2db9b125e6b2113c08cbbca12271e94e7e45 extends \WPML\Core\Twig\Template
{
...
{% if attributes %}
    ...
    <li>
        <label>
            ...
            <input type=\"checkbox\" name=\"attributes[{{ attribute.name }}]\" value=\"1\" {% if attribute.translated %}checked=\"cehcked\"{% endif %} />
            {{ attribute.label }}
        </label>
    </li>
    {% endfor %}
...
", "/setup/attributes.twig", "/var/www/tenta_wp/wp-content/plugins/woocommerce-multilingual/templates/setup/attributes.twig");
    }
}
